...
async def load_project_markers(project_id: str, client_id: str, session_factory) -> dict:
    ...
    async with session_factory() as session:
        ...
        pcw_title   = pcw.window_title   if pcw else None
        pcw_process = pcw.window_process if pcw else None
        ...
        for marker, capture in result.all():
            ...
            markers[marker.name] = {
                ...
                "window_title":   capture.window_title   or pcw_title,
                "window_process": capture.window_process or pcw_process,
                "window_x":       window_x,
                "window_y":       window_y,
            }
        return markers
