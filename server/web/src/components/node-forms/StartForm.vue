<template>
  <div>
    ...
    <div v-for="(field, idx) in d.fields" :key="idx" class="field-group">
      <div class="field-row">
...
function addField() { d.value.fields.push({ name: '', type: 'any', default: '', description: '' }); update() }
...
.field-row { display: flex; align-items: center; gap: 4px; margin-bottom: 3px; }
