...
export const api = {
  ...
  resizeWindowInteractive: (projectId: string, clientId: string, windowTitle?: string) =>
    http.post(`/projects/${projectId}/markers/resize-window-interactive`, { client_id: clientId, ...(windowTitle ? { window_title: windowTitle } : {}) }).then(r => r.data),
  resizeWindowToSize: (projectId: string, clientId: string, targetW: number, targetH: number, windowTitle?: string) =>
    http.post(`/projects/${projectId}/markers/resize-window-to-size`, { client_id: clientId, target_w: targetW, target_h: targetH, ...(windowTitle ? { window_title: windowTitle } : {}) }).then(r => r.data),
